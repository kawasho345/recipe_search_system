...
# sentenceBERTモデルのロード
model = SentenceTransformer('model/sentence-transformers/paraphrase-multilingual-mpnet-base-v2')

# レシピ説明文の埋め込みを生成
recipe_embeddings = model.encode(recipes_df['description'].tolist(), convert_to_tensor=True).cpu().numpy()
